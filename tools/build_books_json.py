#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Собирает вводную часть словарей 1997 и 2017 в assets/books/.

Мациев собирается отдельно (`extract_about.py` -> `assets/about.json`): у него
есть ещё список сокращений и алфавит, а у этих двух книг их нет.
...
# --------------------------------------------------------------------------
# 2. Что где лежит в двух книгах
# --------------------------------------------------------------------------
# Номера абзацев в content.xml. Разделов у обеих книг по два — предисловие и
...
NOTES = {
    'math1997': [
        ...
        '«Показывать долготу» на его статьи не влияет.',
    ...
    'comp2017': [
        ...
        'Убрать тильду совсем можно переключателем «Показывать долготу» в боковом '
        ...
        'и слов с буквой «ё». Показ ударения тоже переключается в боковом меню.',
    ],
}
